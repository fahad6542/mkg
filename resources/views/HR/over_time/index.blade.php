		...
		<div class="col-12">
			<div class="card">
				...
				<div class="card-header border-bottom">
					<h4 class="card-title">Add Over Time</h4>
                    <a type="button" class="btn btn-relief-primary click_if_invalid"  href="{{route('overtime.create')}}" id="">Add New</a>
				</div>
				<!-- Modal -->
   ...
   $('#save_btn').click(function(e) {
    ...
    $('body').on('click', '.delete-btn', function () {
        ...
        if (result.value) {
            ...
            $.ajax({
                type: "DELETE",
                url: "{{ route('overtime.store') }}"+'/'+id, //PK
